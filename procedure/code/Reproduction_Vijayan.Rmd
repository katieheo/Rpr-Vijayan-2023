...
-one paragraph about the Vijayan study + what were the areas of improvement we try to address in this reproduction

## Alternate Study Design
- hexagons
- edits w tables
- edits w variable crt
...
ds_restricted <- ds_orig %>% 
                        ...
                        rename(age18     = DP05_0019P, 
                               ...
                               fid       = fid, 
                               area      = areasqkm, 
                               adjdrt    = adjcrt630_, #Changed back to d!!!!!!!!!!!!!!!
                               adjtrt    = adjtrt630_,
                               westside  = Westside) %>%
...
table3_norho <- do.call(rbind, Map(data.frame,
                             Estimate = SReg.SAR2[["coefficients"]], SReg.SAR2[["rho"]], 
...
Our reproduction study has identically reproduced the original study's quintile maps of testing, diagnosis, and positivity, which were not in the former reproduction study. After fixing the variable on adjusted diagnosis rate that was mis-interpreted in the former reproduction study and 
