...
We found that in the original study's hexagon grid, many adjacent hexagons have gaps between them or have overlap with each other, affecting the result of spatial regression. We create new hexagon grid that fixed the connectivity problem of the hexagon grid in the original study.
